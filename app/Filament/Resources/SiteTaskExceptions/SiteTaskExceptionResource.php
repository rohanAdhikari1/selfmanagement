...
namespace App\Filament\Resources\SiteTaskExceptions;

use App\Filament\Resources\SiteTaskExceptions\Pages\ManageSiteTaskExceptions;
...
class SiteTaskExceptionResource extends Resource
{
    protected static ?string $model = SiteTaskException::class;
    ...
    {
        return [
            'index' => ManageSiteTaskExceptions::route('/'),
        ];
    }
}
